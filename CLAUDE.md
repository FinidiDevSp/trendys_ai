# CLAUDE.md — News Radar Project Operating Guide

> This file is the persistent AI working agreement for Claude Code sessions in this repository.
> Every future execution MUST read and follow this document before making any changes.
...
- Prefer working software over comprehensive documentation, but keep *this* file current.
...
### Backend
- **Python 3.11+**
- **FastAPI** (recommended) or equivalent async-capable framework
- **Pydantic** for data validation and settings
- **SQLAlchemy** or equivalent for ORM (when persistence is added)
...
## 11. Claude Code Behavior Rules

When executing a task in this repository, Claude Code MUST follow these rules:

### Before starting
1. Re-read this `CLAUDE.md` to refresh context.
...
- This document is the source of truth for project structure and conventions.
- If a future task conflicts with this guide, follow this guide unless the user explicitly overrides it.
- When the user makes a decision that changes architectural direction, update this `CLAUDE.md` as part of that execution.
...
| Backend stack | Python 3.11+ + FastAPI + Pydantic |
